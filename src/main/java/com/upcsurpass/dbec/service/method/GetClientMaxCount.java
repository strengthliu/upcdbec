...
public class GetClientMaxCount extends SynchronizedMethod {
	private static final Logger LOGGER = LoggerFactory.getLogger(GetClientMaxCount.class);

	/**
	 * 这里应该修改一下，自动处理，而不应该留给用户
	 * @param pnsc
	 */
	public GetClientMaxCount(PooledNIOSocketClient pnsc) {
		super(pnsc);
	}

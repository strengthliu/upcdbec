...
public class GetHistoryAlarm extends SynchronizedMethod {
	private static final Logger LOGGER = LoggerFactory.getLogger(GetHistoryAlarm.class);

	/**
	 * 这里应该修改一下，自动处理，而不应该留给用户
	 * @param pnsc
	 */
	public GetHistoryAlarm(PooledNIOSocketClient pnsc) {
		super(pnsc);
	}

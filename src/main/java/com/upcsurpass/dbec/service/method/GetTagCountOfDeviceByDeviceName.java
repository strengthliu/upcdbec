...
public class GetTagCountOfDeviceByDeviceName extends SynchronizedMethod {
	private static final Logger LOGGER = LoggerFactory.getLogger(GetTagCountOfDeviceByDeviceName.class);

	/**
	 * 这里应该修改一下，自动处理，而不应该留给用户
	 * @param pnsc
	 */
	public GetTagCountOfDeviceByDeviceName(PooledNIOSocketClient pnsc) {
		super(pnsc);
	}

...
public class GetTagStringFields extends SynchronizedMethod {
	private static final Logger LOGGER = LoggerFactory.getLogger(GetTagStringFields.class);

	/**
	 * 这里应该修改一下，自动处理，而不应该留给用户
	 * @param pnsc
	 */
	public GetTagStringFields(PooledNIOSocketClient pnsc) {
		super(pnsc);
	}

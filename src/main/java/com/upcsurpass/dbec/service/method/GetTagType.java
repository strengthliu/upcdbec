...
public class GetTagType extends SynchronizedMethod {
	private static final Logger LOGGER = LoggerFactory.getLogger(GetTagType.class);

	/**
	 * 这里应该修改一下，自动处理，而不应该留给用户
	 * @param pnsc
	 */
	public GetTagType(PooledNIOSocketClient pnsc) {
		super(pnsc);
	}

...
import upsurpass.com.upcdbec.client.DBEClient;
...
//	}
	...
	public long DBECGetServerCurrentTime(String lpszServerName) {
		GetServerCurrentTime gct = new GetServerCurrentTime(lpszServerName);
//		return gct.doRequest(se);
//		DBEClient c = new DBEClient();
//		c.getObject()
//		c.exec()
